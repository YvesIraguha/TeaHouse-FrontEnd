...
export default () => (
  <div className="submissions__container">
    ...
    <p>
      ...
      to the tea house! [Translation: These will be blog posts in the form of
      short plays. We will pick up interesting stories from around the Rwandan
      mainstream, and imagine them in a fictionalized way, then create out of
      them our own stories. With the photographic law that in public there is no
      privacy, we may decide to use in our plays the original names of the
      individuals involved in the news stories we pick, or mention the news
      story and then create our own fictionalized names. The series will be run
      by the editor or anyone who is interested, who, if so, should submit their
      play via the usual submissions form.]
    </p>
  </div>
);
